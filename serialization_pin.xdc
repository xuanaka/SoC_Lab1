...
set_property -dict {PACKAGE_PIN G22 IOSTANDARD LVCMOS25} [get_ports {i_check}]
set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS25} [get_ports {i_btn}]

set_property -dict {PACKAGE_PIN T6   IOSTANDARD LVCMOS25}  [get_ports {io_gpio}]
